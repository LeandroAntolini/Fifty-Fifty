        ...
        <div className="space-y-4 text-sm text-neutral-dark">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <p>É estritamente proibido usar o serviço para qualquer finalidade ilegal, fraudulenta ou para violar os direitos de outros. Isso inclui o cadastro de informações falsas de imóveis ou clientes.</p>
