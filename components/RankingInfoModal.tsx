        ...
        <div className="space-y-4 text-sm text-neutral-dark">
            <section>
                ...
                <ul className="space-y-2">
                    ...
                    <li className="flex items-start"><ThumbsUp className="text-secondary h-4 w-4 mr-2 mt-0.5 flex-shrink-0" /><span className="font-bold text-green-600">+5 pontos (Bônus):</span>&nbsp;adicionais se for um Super Match (Follow mútuo).</li>
