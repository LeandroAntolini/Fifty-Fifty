        ...
        <div className="space-y-4 text-sm text-neutral-dark">
            <section>
                ...
                <ul className="space-y-2">
                    ...
                    <li className="flex items-start"><Users className="text-secondary h-4 w-4 mr-2 mt-0.5 flex-shrink-0" /><span className="font-bold text-green-600">+2 pontos:</span>&nbsp;por cada Corretor que te segue. (Ajustado)</li>
                </ul>
            </section>
