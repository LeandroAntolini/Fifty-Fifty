...
import { Home, User, ThumbsUp, Handshake, PlusCircle, Users, Building, Briefcase, Award, Heart, UserPlus, Search, ChevronRight } from 'lucide-react';
    ...
    <div className="space-y-3">
      ...
      <Card>
        <CardContent className="p-3 grid grid-cols-3 gap-2">
          <Button onClick={handleAddImovel} className="w-full" variant="white-outline">
            <PlusCircle className="mr-2" size={18} /> Imóvel
          </Button>
          <Button onClick={handleAddCliente} className="w-full" variant="white-outline">
            <PlusCircle className="mr-2" size={18} /> Cliente
          </Button>
          <Button onClick={handleSearchCorretor} className="w-full" variant="white-outline">
      ...
      <Card>
        <CardHeader className="p-3 pb-1 flex flex-row items-center justify-between">
          ...
          <Button variant="link" size="sm" onClick={handleViewPlatformStats} className="h-auto p-0 text-xs flex items-center">
